...
router.route("/").post(protect,restrictTo("user", "admin"),validateDictionarysExists,uploadExcel,saveExcel, readExcel, 
    eliminateExcel, extractData, saveDataDictionary).get(protect,restrictTo("user", "admin"),getAllDictionarysDAE)
